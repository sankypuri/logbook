...
apiRouter.get(
  "/profile/:username/steps",
  userController.ifUserExists,
  userController.apiGetStepsByUsername
);
apiRouter.get(
...
apiRouter.post(
  "/create-step",
  userController.apiMustBeLoggedIn,
  stepsController.apiCreate
);
apiRouter.get("/step/:id", stepsController.reactApiViewSingle);
apiRouter.post(
  "/step/:id/edit",
  userController.apiMustBeLoggedIn,
  stepsController.apiUpdate
);
apiRouter.delete(
  "/step/:id",
  userController.apiMustBeLoggedIn,
  stepsController.apiDelete
);
apiRouter.post(
  "/create-workflow",
  userController.apiMustBeLoggedIn,
  workFlowController.apiCreate
);
...
apiRouter.post(
  "/workflow/:id/edit",
  userController.apiMustBeLoggedIn,
  logbookController.apiUpdate
);
apiRouter.delete(
  "/logbook/:id",
  userController.apiMustBeLoggedIn,
  logbookController.apiDelete
);
module.exports = apiRouter;
